        ...
        <Card className="shadow-lg col-span-2">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-slate-800 dark:text-white">{DAILY_CALORIE_LIMIT}kcal</p>
            </div>
          </div>
          <ProgressBar value={totalCalories} max={DAILY_CALORIE_LIMIT} />

          <div className="mt-4 flex justify-between items-center">
            <div className={`px-3 py-1 rounded-lg ${remainingCalories >= 0
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-right">
              ...
              <p className="text-2xl font-bold text-slate-800 dark:text-white">{user?.dailyCalorieBurn || 400}kcal</p>
            </div>
          </div>
